...
function Experience() {
  ...
  const studies = [
    {
      title: 'Bachelor Informatique - Spécialité Cybersécurité',
      school: 'Ynov Campus Nantes',
      period: '2024 - 2027',
      location: 'Nantes',
      type: 'Actuellement en 2e année',
      description: [
        "Formation en informatique orientée cybersécurité.",
      ],
    },
    {
      title: 'Bac STI2D',
      ...
      type: 'Diplôme obtenu',
      description: [
        "Parcours STI2D au lycée NDBN à Beaupréau.",
      ],
    },
  ];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          {studies.map((study, studyIndex) => (
            <motion.article
              key={`${study.title}-${studyIndex}`}
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7, delay: 0.5 + studyIndex * 0.2 }}
              className="relative pl-12 md:pl-32 pb-12 last:pb-0"
            >
              {/* Timeline Dot */}
              <motion.div
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
                transition={{ type: "spring", stiffness: 200, delay: 0.6 + studyIndex * 0.2 }}
              ...
              <div>
                ...
                <div className="mb-6">
                  <motion.h3
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.7 + studyIndex * 0.2 }}
                  ...
                  <motion.p
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.8 + studyIndex * 0.2 }}
                  ...
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.9 + studyIndex * 0.2 }}
                ...
                <ul className="space-y-3">
                  {study.description.map((point, idx) => (
                    <motion.li
                      key={`${studyIndex}-${idx}`}
                      initial={{ opacity: 0, x: -30 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.5, delay: 1 + studyIndex * 0.2 + idx * 0.1 }}
